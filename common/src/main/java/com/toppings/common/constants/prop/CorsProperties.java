...
public class CorsProperties {
	...
	public static List<String> prodDomains = List.of("toppings.co.kr", "admin.toppings.co.kr", "planet.toppings.co.kr");
	...
	public static List<String> devUrls = List.of("http://127.0.0.1:80", "http://127.0.0.1:3000",
		...
		"https://planet.toppings.co.kr", "https://dev-admin.toppings.co.kr", "https://dev-planet.toppings.co.kr"
	);
